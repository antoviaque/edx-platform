...
# Splash screen
SPLASH_SCREEN_COOKIE_NAME = ENV_TOKENS.get('SPLASH_SCREEN_COOKIE_NAME', SPLASH_SCREEN_COOKIE_NAME)
SPLASH_SCREEN_COOKIE_ALLOWED_VALUES = ENV_TOKENS.get('SPLASH_SCREEN_COOKIE_VALUES',
                                                     SPLASH_SCREEN_COOKIE_ALLOWED_VALUES)
SPLASH_SCREEN_UNAFFECTED_USERS = ENV_TOKENS.get('SPLASH_SCREEN_UNAFFECTED_USERS',
                                                SPLASH_SCREEN_UNAFFECTED_USERS)
SPLASH_SCREEN_REDIRECT_URL = ENV_TOKENS.get('SPLASH_SCREEN_REDIRECT_URL', SPLASH_SCREEN_REDIRECT_URL)
